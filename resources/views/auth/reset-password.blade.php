...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .auth-card .lede{color:var(--paper-dim);font-size:14px;margin-bottom:26px}
...
<body>
    ...
    <main class="auth-main">
        <div class="auth-card reveal">
            ...
            <p class="lede">Make it something you haven't used before.</p>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="field">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" placeholder="you@pb.edu.bn" required autofocus autocomplete="username">
